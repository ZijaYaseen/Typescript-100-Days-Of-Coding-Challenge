...
*/
var friends = ["zija", "shizra", "unzila", "khazina"];
console.log(friends[4]); // output error, : Arrays are zero indexed, so index 4 is out of bounds.
console.log(friends[2]); // correcting the error or by accessing correct index.
