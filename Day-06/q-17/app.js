...
var popedNames = guests.splice(2, guests.length);
for (var i = 0; i < popedNames.length; i++) {
    console.log("Sorry ".concat(popedNames[i], ", I can't invite you to dinner."));
}
for (var i = 0; i < guests.length; i++) {
    console.log("".concat(guests[i], ", You'r still invited to dinner."));
}
